...
export const LANDING_LOGOS = {
  ...
  spotify: `data:image/svg+xml,${encodeURIComponent(`
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100">
      <rect width="100" height="100" fill="white" rx="12"/>
      <circle cx="50" cy="50" r="38" fill="#1DB954"/>
      <path fill="white" d="M68 62c-1.5 0-2.3-.5-3.5-1.2-8-4.8-17.5-5.5-28-3.5-2 .4-3.5 1-5 1-2.5 0-4-1.8-4-4 0-2.5 1.5-4 4-4.5 12-2.5 24-2 35 4 2 1 3.5 2.5 3.5 5 0 2-1 3.2-2 3.2zm4-12c-1.5 0-2.5-.5-4-1.5-9.5-5.5-22-7-34-4-2 .5-3.5 1-5 1-3 0-5-2-5-5 0-3 2-5 4.5-5.5 5-1.5 10-2 16-2 12 0 22 3 31 8.5 2 1.2 3.5 3 3.5 5.5 0 2.5-2 5-6 3zm5-14c-2 0-3-.5-5-1.5C60.5 27.5 44 26 31 28c-2 .3-4 1-6 1-3.5 0-6-2.5-6-6s2-5.5 5-6c6-1.5 12-2 19-2 14 0 27 3 38 10 2.5 1.5 4 3.5 4 7 0 3.5-3 6-6 6z"/>
    </svg>
  `.trim())}`,
