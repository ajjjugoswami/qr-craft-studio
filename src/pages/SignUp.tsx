...
const SignUp: React.FC = () => {
  ...
  const handleGoogleSignUp = () => {
    // This is triggered by clicking the button, but the actual sign-in is handled by the Google button
    if (window.google && GOOGLE_CLIENT_ID) {
      window.google.accounts.id.prompt();
    } else {
      message.warning("Google Sign-In is not configured. Please add VITE_GOOGLE_CLIENT_ID to your environment variables.");
    }
  };
