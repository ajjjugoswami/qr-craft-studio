    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-purple-500/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0" styles={{ body: { padding: '32px' } }}>
          <Title level={3} className="!mb-2 text-center">Create Account</Title>
          <Paragraph type="secondary" className="text-center mb-6">Get started with your free account</Paragraph>
          ...
          <div className="text-center mt-6">
            ...
            <Link to="/signin">
              <Button type="link" className="!p-0 !h-auto font-medium">Sign in</Button>
            </Link>
          </div>
        </Card>
